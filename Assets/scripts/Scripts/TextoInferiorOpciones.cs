...
public class TextoInferiorOpciones : MonoBehaviour 
{
	...
	{
		textoVentana.text = GameCenter.InstanceRef.controladoraJuego.textosMenusTraduccion.Inspeccionando + " \"" + GameCenter.InstanceRef.controladoraJuego.interactuablePulsado.Descripcion + "\"";
